...
const Slider = ({ slides }) => {
  ...
  const handleTap = () => {
    setShowDetails((prev) => !prev); // Toggle details on tap
  };
      ...
      >
        {slides.map((slide, index) => (
          <div
            ...
            onClick={handleTap} // Tap event handler
          >
            {/* Image Container */}
            <a
              href={slide.link}
            ...
            >
              ...
              />
              {/* Show title and description only when hovered or tapped */}
              {(isHovered || showDetails) && (
                <div className="absolute inset-0 flex flex-col items-center justify-center bg-black bg-opacity-50 text-white px-4 py-2">
