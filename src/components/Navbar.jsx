...
const Navbar = () => {
    ...
    return (
        <nav className="   fixed container w-full mt-5 lg:mt-0 px-2  flex items-center justify-between z-50">
            ...
            <img
  className="hover:contrast-180 w-32 cursor-pointer dark:hidden"
  src={logoLight}
  alt="logo-light"
/>
<img
  className="hover:contrast-180 w-32 cursor-pointer hidden dark:block"
  src={logo}
  alt="logo-dark"
/>
            ...
            <div className="-ml-0.5 m-6 flex items-center justify-center gap-4 text-2xl cursor-pointer">
               <div className="hidden lg:flex "> <ThemeChange /></div>
                ...
                <ul className="text-black dark:text-gray-200 hidden lg:flex m-6 items-center justify-center gap-4 text-2xl cursor-pointer ">
